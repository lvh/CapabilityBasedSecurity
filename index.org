...
*** Authentication is tricky, too
    ...
    (but we'll focus on authorization)
...
*** Repositories ≈ everything
    ...
    All I wanted was an issue tracker!
...
** So far, our tools work like this:
...
** Can't we just improve access control?

    * Probably not
    * Access control is already a mess
...
*** Dependent typed problem
    ...
    #+ATTR_REVEAL: :frag (roll-in)
    * Most AC systems can express stuff like:
